...
(() => {
  ...
  window.PinkPublicConfig=Object.freeze({schemaVersion:2,appVersion:'12.5.4',environment,
    ...
    nvidia:Object.freeze({primaryReasoning:'nvidia/nemotron-3-super-120b-a12b',capabilities:Object.freeze({rag:'rag-blueprint',research:'aiq-research',optimization:'cuopt',dataframeGpu:'cudf',visionPipeline:'deepstream'})}),
    ...
    features:Object.freeze({pink3d:true,pinkOrbVoice:true,holographicUI:true,geminiLive:true,pinkVision:true,nvidiaFallback:true,browserVoiceFallback:false,cloudMemory:environment==='production',multiAgent:true,pinkStudio:true,toolLayer:true,agentHarness:true,companion:true,autonomousEvolution:true,autonomyConsole:true,engineeringEvolution:true,observability:true,enterprise:true})});
  if(typeof document==='undefined')return;
  const phaseModules=Object.freeze([['governance/pink-autonomy-console.js','governance-autonomy'],['observability/pink-observability.js','phase10-observability'],['runtime/pink-agent-harness.js','v14-agent-harness'],['agents/pink-openai.js','chatgpt-supervisor'],['agents/pink-gemini-research.js','gemini-grounded-research'],['agents/pink-model-router.js','phase5-multi-agent'],['agents/pink-unified-ai-gateway.js','unified-ai-gateway'],['core/pink-intent-context-router.js','intent-context-router'],['vision/pink-vision.js','pink-vision'],['vision/pink-camera-router.js','pink-camera-router'],['studio/pink-studio.js','phase6-studio'],['tools/pink-tool-registry.js','phase7-tools'],['companion/pink-companion.js','phase8-companion'],['evolution/pink-autonomous-evolution.js','phase9-evolution'],['evolution/pink-engineering-loop.js','engineering-evolution-loop'],['governance/pink-engineering-panel.js','governance-engineering-panel'],['enterprise/pink-enterprise.js','phase11-enterprise'],['platform/pink-platform.js','phase5-11-platform']]);
  ...
  async function loadOrbVoice(){
    if(!document.querySelector('link[data-pink-orb-style]')){const link=document.createElement('link');link.rel='stylesheet';link.href=new URL('visual/pink-orb-console.css?v=1.0.0',document.baseURI).href;link.dataset.pinkOrbStyle='1';document.head.appendChild(link)}
