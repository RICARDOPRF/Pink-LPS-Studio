...
(() => {
  ...
  window.PinkPublicConfig=Object.freeze({schemaVersion:2,appVersion:'12.3.0',environment,
    ...
    governance:Object.freeze({autonomyLevels:true,defaultAutonomyLevel:2,policy:'AUTONOMY_ENVELOPE_PLUS_APPROVAL_GATE'}),
    features:Object.freeze({pink3d:true,holographicUI:true,geminiLive:true,pinkVision:true,nvidiaFallback:true,browserVoiceFallback:false,cloudMemory:environment==='production',multiAgent:true,pinkStudio:true,toolLayer:true,companion:true,autonomousEvolution:true,autonomyConsole:true,observability:true,enterprise:true})});
  if(typeof document==='undefined')return;
  const phaseModules=Object.freeze([['governance/pink-autonomy-console.js','governance-autonomy'],['observability/pink-observability.js','phase10-observability'],['agents/pink-openai.js','chatgpt-supervisor'],['agents/pink-model-router.js','phase5-multi-agent'],['agents/pink-unified-ai-gateway.js','unified-ai-gateway'],['core/pink-intent-context-router.js','intent-context-router'],['vision/pink-vision.js','pink-vision'],['studio/pink-studio.js','phase6-studio'],['tools/pink-tool-registry.js','phase7-tools'],['companion/pink-companion.js','phase8-companion'],['evolution/pink-autonomous-evolution.js','phase9-evolution'],['enterprise/pink-enterprise.js','phase11-enterprise'],['platform/pink-platform.js','phase5-11-platform']]);
